...
error_log("Request Action :" . $_REQUEST['action']);
...
/* sso login start     添加check  action ********************/
...
/* sso join end............................. */
	...
	if ( $customize_login )
	{
	    error_log("customize-login is true.");
		wp_enqueue_script( 'customize-base' );
	}

	// If the user wants ssl but the session is not ssl, force a secure cookie.
	if ( !empty($_POST['log']) && !force_ssl_admin() ) {
	    error_log("post[l'og'] = " . $_POST['log']);
		...
		if ( $user ) {
			if ( get_user_option('use_ssl', $user->ID) ) {
				$secure_cookie = true;
				error_log("$secure_cookie : " . $secure_cookie);
...
/* sso join begin............................. */
    ...
    $user = s_wp_signon($u_exist,$secure_cookie);
/* sso join end ............................. */
